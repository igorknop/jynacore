...
public class EulerMethod2Test {
	...
	private SystemDynamicsModel model4;
	...
	public void setUpModel1(){
		...
		finLevel.setInitialValue(new DefaultNumberConstantExpression(0.0));
	...
	private void setUpModel2() {
		...
		finLevel2.setInitialValue(new DefaultNumberConstantExpression(10.0));

		finLevel3 = new DefaultFiniteStock();
		//finLevel3.setInitialValue(0.0);
		finLevel3.setInitialValue(new DefaultNumberConstantExpression(0.0));
	...
	public void setUpModel3(){
		...
		finLevel4.setInitialValue(new DefaultNumberConstantExpression(100.0));

		finLevel5 = new DefaultFiniteStock();
		//finLevel5.setInitialValue(1.0);
		finLevel5.setInitialValue(new DefaultNumberConstantExpression(1.0));
	...
	@Test
	public final void testExponentialGrowth() throws Exception{
		SystemDynamicsSimulationMethod method3 = new DefaultSystemDynamicsEulerMethod();
		method3.setModel(new ExponencialGrowth());
		method3.setInitialTime(0.0);
		method3.setStepSize(1.0);
		method3.reset();
		method3.step();
	...
	@Test
	public final void testExponentialGrowthLoadingFromFile() throws Exception{
