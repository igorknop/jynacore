 ...
 *
 */
public class DefaultClassInstanceMultiRelation implements
		ClassInstanceMultiRelation {

	private String name;
	private Map<String, ClassInstance> targets;
	private ClassInstance classInstance;
	
	public DefaultClassInstanceMultiRelation() {
		targets = new HashMap<String, ClassInstance>();
	}
	...
	@Override
	public Map<String, ClassInstance> getTargets() {
		return targets;
	}

	@Override
	public void setTargets(Map<String, ClassInstance> newTargets) {
		targets = newTargets;
	}
